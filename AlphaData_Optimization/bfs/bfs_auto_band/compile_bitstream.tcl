...
# Host Compiler Flags
set_property -name host_cflags -value "-g -Wall -D FPGA_DEVICE -D C_KERNEL -I/curr/cody/Spark_ACC/HDLRevisit/MachSuitePlus/common"  -objects [current_solution]
...
add_files -kernel [get_kernels workload] "bfs.cpp"
...
run_emulation -flow cpu -args "/curr/cody/Spark_ACC/HDLRevisit/AlphaData_Optimization/bfs/bfs_auto_band/input.data /curr/cody/Spark_ACC/HDLRevisit/AlphaData_Optimization/bfs/bfs_auto_band/check.data workload.xclbin"
