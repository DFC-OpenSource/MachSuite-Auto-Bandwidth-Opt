...
# Host Compiler Flags
set_property -name host_cflags -value "-g -Wall -D FPGA_DEVICE -D C_KERNEL -I/curr/cody/Spark_ACC/HDLRevisit/AlphaData_Optimization/common"  -objects [current_solution]
...
add_files -kernel [get_kernels workload] "nw.cpp"
...
run_emulation -flow cpu -args "/curr/cody/Spark_ACC/HDLRevisit/AlphaData_Optimization/nw/nw_band_opt/input.data /curr/cody/Spark_ACC/HDLRevisit/AlphaData_Optimization/nw/nw_band_opt/check.data workload.xclbin"
