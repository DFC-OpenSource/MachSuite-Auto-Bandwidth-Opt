...
run_emulation -flow cpu -args "/curr/cody/Spark_ACC/HDLRevisit/AlphaData_Optimization/sort/merge_auto_band/input.data /curr/cody/Spark_ACC/HDLRevisit/AlphaData_Optimization/sort/merge_auto_band/check.data workload.xclbin"
